...
public Rekening(String nomor, String nama, double saldoAwal, String pin) {
	...
	if (pinAwal != null && pinAwal.length() == 6) {
		...
		System.out.println("Peringatan: PIN harus 6 digit! Mennggunakan PIN default 123456");
		this.pinAwal = "000000";
	}
...
public String getNamaPemilik1() {return namaPemilik; }


//4. Method untuk atribut yang diizinkan dibaca publik
public boolean otentikasi(String pinYangDiinput) {
	if (this.pinAwal == null || pinYangDiinput == null) {
		
	}
	return this.pinAwal.equals(pinYangDiinput);
}
